...
from coingro.enums import RPCMessageType
...
class RPCManager:
    ...
    def __init__(self, coingro_controller) -> None:
        ...
        self._rpc = RPC(coingro_controller)
        config = coingro_controller.config
    ...
    def send_msg(self, msg: Dict[str, Any]) -> None:
        ...
        if 'pair' in msg:
            msg.update({
                'base_currency': self._rpc._coingro.exchange.get_pair_base_currency(msg['pair'])
                })
