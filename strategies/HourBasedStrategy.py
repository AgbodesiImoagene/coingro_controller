...
class HourBasedStrategy(IStrategy):
    ...
    # 158/1000:     51 trades. 29/19/3 Wins/Draws/Losses. Avg profit   4.02%.
    # Median profit   2.48%. Total profit  4867.53438466 USDT ( 486.75%).
    # Avg duration 1 day, 19:38:00 min. Objective: -4.17276
    ...
    # SHIB/USDT, 1000$x1:100days
    # 36/1000:    113 trades. 55/14/44 Wins/Draws/Losses. Avg profit   2.06%.
    # Median profit   0.00%. Total profit  5126.14785426 USDT ( 512.61%).
    # Avg duration 16:48:00 min. Objective: -4.57837
    ...
    # 72/1000:    158 trades. 67/13/78 Wins/Draws/Losses. Avg profit   1.37%.
    # Median profit   0.00%. Total profit  4274.73622346 USDT ( 427.47%).
    # Avg duration 13:50:00 min. Objective: -4.87331
    ...
    # 7/1000:     65 trades. 40/23/2 Wins/Draws/Losses. Avg profit   6.42%.
    # Median profit   7.59%. Total profit  41120.00939125 USDT ( 4112.00%).
    # Avg duration 1 day, 9:40:00 min. Objective: -8.46089
    ...
    # {KDA/USDT, BTC/USDT, DOGE/USDT, SAND/USDT, ETH/USDT, SOL/USDT}, 1000$x1:100days,
    # ShuffleFilter42
    # 56/1000:     63 trades. 41/19/3 Wins/Draws/Losses. Avg profit   4.60%.
    # Median profit   8.89%. Total profit  11596.50333022 USDT ( 1159.65%).
    # Avg duration 1 day, 14:46:00 min. Objective: -5.76694
