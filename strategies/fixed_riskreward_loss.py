...
class FixedRiskRewardLoss(IStrategy):
    ...
    def custom_stoploss(self, pair: str, trade: 'Trade', current_time: datetime,
        ...
        if custom_info_pair is not None:
            ...
            open_date_mask = \
                custom_info_pair.index.unique().get_loc(trade.open_date_utc, method='ffill')
            ...
            break_even_profit_distance = \
                risk_distance * self.custom_info['set_to_break_even_at_profit']
            ...
            if(current_profit >= break_even_profit_pct):
                break_even_sl = (trade.open_rate * (1 + trade.fee_open +
                                                    trade.fee_close) / current_rate) - 1
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        self.custom_info[metadata['pair']] = \
            dataframe[['date', 'stoploss_rate']].copy().set_index('date')
